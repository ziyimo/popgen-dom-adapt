...
SCRIPT="${GITDIR}/sft_xtreme_cont.slim"
...
for sim in $(seq 1 $RUNS); do
    ...
    do
        ...
        ${GITDIR}/msprime_init.py s $SC_MIN $SC_MAX $NBTLNK ${OUTPREF}_${RUN_ID}
        INIT_RTCD=$?
        ...
        END_FREQ=$(grep "%%" logs/${JOB_ID}_${SGE_TASK_ID}.buf | awk '{ print $4 }')
        ...
        ${GITDIR}/samp_tree.py ${OUTPREF}_${RUN_ID} $NOIDVL s
        REC_RTCD=$?
